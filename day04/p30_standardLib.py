...
curr2 = time.localtime() # time으로 찾는 localtime() 잘 안씀
print(curr2)

## 많이 쓰임
# for i in range(5):
#     print(f'{i} 출력')
#     time.sleep(2) # 2초씩 딜레이

##
print(random.random()) # 0 ~ 1 사이의 소수점 랜덤 수 
print(random.randint(1,45)) # 1 ~ 45 사이의 랜덤 수 
